...
import { Page1, Page2, Page3, Page4, Page5 } from "../BeginnerLevel/Pagesfor3";

export default function EasyGrammerforpre18(props) {
  const history = useHistory();
  let pages = props.pages;
  const Head = [
    {
      heading: "1.	VERB TO BE",
      p: "The verb to be or to be",
    },
    {
      heading: "1.	VERB TO BE",
      p: "The verb to be or to be",
    ...
    {
      heading: "two.	VERB TO BE (MEANING EXCEPTION)",
      p: "	Verb to be or to be (exception of meaning)",
    },
    {
      heading: "two.	VERB TO BE (MEANING EXCEPTION)",
      p: "	Verb to be or to be (exception of meaning)",
