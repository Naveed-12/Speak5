...
import { Page1, Page2, Page3, Page4, Page5, Page6, Page7 } from "../BeginnerLevel/Pagesfor6";

export default function EasyGrammerforpre11(props) {
  const history = useHistory();
  let pages = props.pages;
  const Head = [
    {
      heading: "1.	PLURAL AND SINGULAR NOUNS",
      p: "	Plural and singular nouns",
    },
    {
        heading: "2.	PLURAL AND SINGULAR NOUNS",
      p: "	Plural and singular nouns",
    },{
      heading: "3.	PLURAL AND SINGULAR NOUNS",
      p: "	Plural and singular nouns",
    },{
