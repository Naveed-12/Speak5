...
import { Page1, Page2, Page3 } from "./Pagesforpre10";

export default function EasyGrammerforpre10(props) {
  const history = useHistory();
  let pages = props.pages;
  const Head = [
    {
      heading: "1.	DEMONSTRATIVE PRONOUNS AND ADJECTIVES",
      p: "DEMONSTRATIVE PRONOUNS AND ADJECTIVES",
    },
    {
      heading: "2.	DEMONSTRATIVE ADJECTIVES",
      p: "Adjetivos demostrativos",
    },
    {
      heading: "3.	DEMONSTRATIVE PRONOUNS",
      p: "3.	DEMONSTRATIVE PRONOUNS",
    },
    {
      heading: "1..	OBJECT PRONOUN",
      p: "OBJECT PRONOUN",
    },
    {
      heading: "1..	OBJECT PRONOUN",
