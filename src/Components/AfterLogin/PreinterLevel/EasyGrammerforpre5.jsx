...
export default function EasyGrammerforpre5(props) {
  const history = useHistory();
  let pages = props.pages;
  const Head = [
    {
      heading: "1.	PREPOSITIONS",
      p: "PREPOSITIONS",
    },
    {
        heading: "1.	PREPOSITIONS",
    ...
    {
        heading: "two.	PREPOSITIONS OF MOVEMENT",
      p: "	motion prepositions",
    },
    {
        heading: "two.	PREPOSITIONS OF MOVEMENT",
      p: "PREPOSITIONS OF MOVEMENT",
    },
    {
        heading: "two.	PREPOSITIONS OF MOVEMENT",
      p: "PREPOSITIONS OF MOVEMENT",
