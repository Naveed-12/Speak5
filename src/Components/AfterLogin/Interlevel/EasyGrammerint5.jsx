...
export default function EasyGrammerint5(props) {
  const history = useHistory();
  let pages = props.pages;
  const Head = [
    {
      heading: "1.	PAST CONTINUOUS",
      p: "past continuous",
    },
    {
        heading: "1.	PAST CONTINUOUS",
    ...
    {
        heading: "two.	PAST CONTINUOUS (NEGATIVE FORM)",
      p: " Past continuous (negative form)",
    },
    {
        heading: "3.	PAST CONTINUOUS (QUESTION FORM)",
      p: " Past continuous (interrogative form)",
    },
    {
