...
export default function EasyGrammerint19(props) {
  const history = useHistory();
  let pages = props.pages;
  const Head = [
    {
      heading: "1.	PAST PERFECT CONTINUOUS",
      p: " 	past perfect continuous",
    },
    {
        heading: "two.	PAST PERFECT CONTINUOUS (NEGATIVE FORM )",
      p: "Past perfect continuous (negative form)",
    },
    {
        heading: "3.	PAST PERFECT CONTINUOUS (QUESTION FORM)",
      p: "Past perfect continuous (interrogative form)",
    },
    {
