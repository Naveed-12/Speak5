...
import {
  ...
  Page2,
  Page3,
} from "../BeginnerLevel/Pagesfor16";

export default function EasyGrammerint9(props) {
  const history = useHistory();
  let pages = props.pages;
  const Head = [
    {
      heading: "1.	ACTIVITY AND STATE VERBS",
      p: "		ACTIVITY AND STATE VERBS",
    },
    {
      heading: "two.	STATE VERBS",
      p: "STATE VERBS",
    },
    {
        heading: "two.	STATE VERBS",
