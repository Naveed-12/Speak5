...
import { Page1, Page2, Page3,  } from "./Pagesforadvance8";

export default function EasyGrammeradvance8(props) {
  const history = useHistory();
  let pages = props.pages;
  const Head = [
    {
      heading: "1.	FUTURE CONTINUOUS",
      p: "	Future continuous (negative form)",
    },
    {
        heading: "two.	FUTURE CONTINUOUS (NEGATIVE FORM)",
      p: "	The present simple and the present continuous to talk about the future",
    },{
        heading: "3.	FUTURE CONTINUOUS (INTERROGATIVE FORM)",
      p: "Future continuous (interrogative form)",
    },{
