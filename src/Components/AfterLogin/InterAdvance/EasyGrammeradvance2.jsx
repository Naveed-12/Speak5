...
import { Page1, Page2, Page3, } from "./Pagesforadvance2";

export default function EasyGrammeradvance2(props) {
  ...
  const Head = [
    ...
    {
        heading: "	two.	First CONDITIONAL (NEGATIVE FORM )",
      p: "	First conditional (negative form)",
    },{
        heading: "3.	First CONDITIONAL (QUESTION FORM )",
      p: "	First conditional (interrogative form)",
    },{
