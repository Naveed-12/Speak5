...
import { Page1, Page2, Page3,  } from "./Pagesforadvance7";

export default function EasyGrammeradvance7(props) {
  const history = useHistory();
  let pages = props.pages;
  const Head = [
    {
      heading: "	1.	PRESENT SIMPLE AND PRESENT CONTINUOUS TO TALK ABOUT THE FUTURE",
