  ...
  return (
    <div>
      <div className="container kk">
        <p>In this lesson we will learn to use the Second conditional.</p>
        <p>
          We use the Second conditional to talk about something that could happen
...
export const Page2 = () => {
  ...
  return (
    <div>
      <div className="container kk">
        <p>
          To use the Second conditional in negation, we just have to add don't
          after the subject ( doesn't if we are talking about he , she , or it )
          in the Second part of the sentence (before the comma), and not after
...
export const Page3 = () => {
  ...
  return (
    <div>
      <div className="container kk">
        <p>
          We can ask questions with the Second conditional in various ways. The
        ...
        <p>
          However, we can ask questions with the Second conditional in other ways
