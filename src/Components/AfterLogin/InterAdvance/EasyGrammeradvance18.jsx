...
import { Page1, Page2, Page3,Page4 } from "./Pagesforadvance18";

export default function EasyGrammeradvance18(props) {
  const history = useHistory();
  let pages = props.pages;
  const Head = [
    {
      heading: " 1.	BY, BY THE TIME, WHILE",
      p: "For, by the time, while",
    },
    {
        heading: " two.	B Y",
      p: "For/Before",
    },{
        heading: " 3.	BY THE TIME",
        p:"For the moment that / before the moment that"
    },{
        heading: "Four WHILE",
      p: "While",
     },{
        heading: " 1. NEITHER, EITHER, BOTH",
      p: "NEITHER, EITHER, BOTH",
     },{
        heading: "1.POSSESSIVE FORMS",
      p: "POSSESSIVE FORMS",
     },{
        heading: "1.POSSESSIVE FORMS",
      p: "POSSESSIVE FORMS",
