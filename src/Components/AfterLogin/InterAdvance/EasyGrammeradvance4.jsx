...
import { Page1, Page2, Page3, } from "./Pagesforadvance4";

export default function EasyGrammeradvance4(props) {
  const history = useHistory();
  let pages = props.pages;
  const Head = [
    {
      heading: "1.	Third CONDITIONAL",
      p: "	Conditional Third",
    },
    {
        heading: "	two.	Third CONDITIONAL (NEGATIVE FORM )",
      p: "	Third conditional (negative form)",
    },{
