...
import { Page1, Page2, Page3, } from "./Pagesforadvance3";

export default function EasyGrammeradvance3(props) {
  const history = useHistory();
  let pages = props.pages;
  const Head = [
    {
      heading: "1.	Second CONDITIONAL",
      p: "	Conditional Second",
    },
    {
        heading: "	two.	Second CONDITIONAL (NEGATIVE FORM )",
      p: "	Second conditional (negative form)",
    },{
        heading: "3.	Second CONDITIONAL (QUESTION FORM )",
      p: "	Second conditional (interrogative form)",
    },{
