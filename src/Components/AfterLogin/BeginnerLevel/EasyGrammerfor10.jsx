...
import { Page1, Page2, Page3, Page4, Page5 } from "./Pagesfor10";

export default function EasyGrammerfor10(props) {
  const history = useHistory();
  let pages = props.pages;
  const Head = [
    {
      heading: "1.	DAYS, MONTHS AND COLORS",
      p: "	days, months and colors",
    },
    {
      heading: "2.	DATES",
      p: "Dates",
