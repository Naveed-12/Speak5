...
import { Page1, Page2, Page3, Page4, Page5 } from "./Pagesfor13";

export default function EasyGrammerfor13(props) {
  const history = useHistory();
  let pages = props.pages;
  const Head = [
    {
      heading: "1.	HOW TO ASK FOR THE TIME",
      p: "HOW TO ASK FOR THE TIME",
    },
    {
      heading: "1.	HOW TO ASK FOR THE TIME",
      p: "HOW TO ASK FOR THE TIME",
